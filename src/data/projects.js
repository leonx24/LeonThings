...
export const projects = [
  {
    ...
    overview:
      "Leon X is a Roblox scripting project focused on clean UI, performance and modern execution experience.",

    challenge:
      "Build a powerful Roblox utility while keeping the interface simple, responsive and easy to navigate.",
